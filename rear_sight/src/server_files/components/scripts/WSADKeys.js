...
function set_keydown(key_code) {
    if (key_code === 'ArrowUp')
    ...
    else if (key_code === 'f' || key_code === 'F')
        isF_ButtonPushed = true;
        ...
        isLeftSquareBracket_ButtonPushed = true;
    }
    else if (key_code === ']') {
...
function set_keyup(key_code) {
    if (key_code === 'ArrowUp')
        ...
        isLeftSquareBracket_ButtonPushed = false;
    }
    else if (key_code === ']') {
